...
describe('== 6. 大六壬（月将为重点）==', () => {
  it('19 个月将对照（2024 精确中气时刻为界）', () => {
    // 月将按精确中气时刻换将（2026-09 起）：大寒 1/20 22:07、雨水 2/19 12:13、春分 3/20 11:06 …
    const expectList: [string, string][] = [
      ['2024-01-01T12:00', '丑'], ['2024-01-20T12:00', '丑'], // 大寒 22:07 前仍丑
      ['2024-01-21T12:00', '子'], ['2024-02-10T12:00', '子'], ['2024-02-19T12:00', '子'], // 雨水 12:13 前仍子
      ['2024-02-20T12:00', '亥'], ['2024-03-21T12:00', '戌'], ['2024-04-20T12:00', '酉'],
      ['2024-05-21T12:00', '申'], ['2024-06-21T12:00', '未'], ['2024-07-23T12:00', '午'],
      ['2024-08-18T12:00', '午'], ['2024-08-23T12:00', '巳'], ['2024-09-23T12:00', '辰'],
      ['2024-10-23T12:00', '卯'], ['2024-11-22T12:00', '寅'], ['2024-12-22T12:00', '丑'],
      ['2024-12-25T12:00', '丑'],
    ];
