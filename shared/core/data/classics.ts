...
export const CLASSICS: ClassicBook[] = [
  ...
  },
  {
    ...
    excerpts: [
      ...
      {
        title: '天干·甲木（节选）', source: '《滴天髓阐微·天干》',
        original: '甲木参天，脱胎要火。春不容金，秋不容土。火炽乘龙，水宕骑虎。地润天和，植立千古。',
        translation: '甲木如参天大树，萌芽初生时需要火来温暖生发。春天木旺不喜金来克伐，秋天木衰不喜土重埋根。火太旺时需湿土（辰）来泄，水太旺时需燥土（寅）来制。地润天和，方能植立千古。',
        annotation: '《滴天髓·天干》十干总诀之一，为甲木调候本源（《穷通宝鉴》转引）。「地润天和，植立千古」为甲木成格之象。',
      },
    ],
  ...
  },
  {
    ...
    excerpts: [
      {
        title: '论甲木（节选）', source: '《穷通宝鉴·甲木》（转引自《滴天髓·天干》）',
        ...
        annotation: '此为甲木调候总诀。本源见《滴天髓·天干》（全文含「地润天和，植立千古」），《穷通宝鉴》转引之，两书互见。',
      },
    ],
  ...
  },
  {
    ...
    excerpts: [
      {
        title: '太微赋（节选）', source: '《紫微斗数全书·卷一·太微赋第一》',
        original: '斗数至玄至微，理旨难明，虽设问于百篇之中，犹有言而未尽。至如星之分野，各有所属，寿夭贤愚，富贵贫贱，不可一概论议。其星分布于十二垣，数定乎三十六位，入庙为奇，失度为虚。星临庙旺，再观生克之机；命坐强宫，细察制化之理。',
        translation: '斗数极为玄妙精微，其理旨难以尽明，即便设问于百篇之中，仍有言犹未尽之处。星曜各有分野归属，寿夭贤愚、富贵贫贱不可一概而论。星曜分布于十二宫垣，定数于三十六位星系格局：入庙为奇，失度为虚。星临庙旺之位，还需再看生克制化之机；命坐强旺之宫，要细察制化之理。',
        annotation: '「入庙为奇，失度为虚」「星临庙旺，再观生克之机」：庙旺落陷与生克制化，是斗数断吉凶的两大枢纽。',
      },
    ],
